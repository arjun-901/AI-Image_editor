  ...
  return (
    <header className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 text-nowrap">
      ...
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-full px-8 py-3 flex items-center justify-between gap-8">
        {/* Logo */}
        <Link href="/" className="mr-1 md:mr-20">
          <h1 className="sm:text-3xl text-xl font-extrabold drop-shadow-[0_5px_10px_rgba(0,0,0,0.6)]">
            
            <span className="text-green-500 brightness-150 drop-shadow-[0_0_15px_rgba(34,197,94,0.9)]">
              Angle
            </span>
          </h1>
